<footer class="footer">
    <div class="container">
    <div class="row">
  <div class="col-md-4"><div class="widget"><a href="<?php echo Yii::getAlias('@web') ?>"><img src="<?php echo Yii::$app->params['baseUrl'];?>images/footer-logo.png"><br> Elevating your health</a></div></div>
